...
@Component({
  selector: 'app-analytics-filter-shell',
  standalone: true,
  templateUrl: './analytics-filter-shell.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AnalyticsFilterShellComponent implements OnChanges, AfterViewInit, OnDestroy {
  @Input()  open = false;
  ...
  ngAfterViewInit(): void {
    if (typeof window.filterModalInit === 'function') {
      window.filterModalInit('service');
