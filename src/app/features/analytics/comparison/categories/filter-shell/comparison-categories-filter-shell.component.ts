...
@Component({
  selector: 'app-comparison-categories-filter-shell',
  standalone: true,
  templateUrl: './comparison-categories-filter-shell.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ComparisonCategoriesFilterShellComponent implements OnChanges, AfterViewInit, OnDestroy {
  @Input()  open    = false;
  @Input()  context = 'comparison-categories';
