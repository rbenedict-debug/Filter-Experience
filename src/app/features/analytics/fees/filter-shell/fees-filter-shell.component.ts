...
@Component({
  selector: 'app-fees-filter-shell',
  standalone: true,
  templateUrl: './fees-filter-shell.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FeesFilterShellComponent implements OnChanges, AfterViewInit, OnDestroy {
  @Input()  open    = false;
  @Input()  context = 'fees';
