...
@Component({
  selector: 'app-call-center-filter-shell',
  standalone: true,
  templateUrl: './call-center-filter-shell.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CallCenterFilterShellComponent implements OnChanges, AfterViewInit, OnDestroy {
  @Input()  open    = false;
  @Input()  context = 'call-center-overview';
