...
@Component({
  selector: 'app-custom-reports-filter-shell',
  standalone: true,
  templateUrl: './custom-reports-filter-shell.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CustomReportsFilterShellComponent implements OnChanges, AfterViewInit, OnDestroy {
  @Input()  open    = false;
  @Input()  context = 'custom-reports';
